...
template<typename code_t = uint64_t,typename ch_t = uint16_t,int MODE = 0,int alphabet_size = 65536>
...
public:
    ...
    TBL_WIDTH(std::log2(alphabet_size)),ca(MODE>0 ? std::log2(alphabet_size) : 0),act(alphabet_size){
        std::vector<int> left_child_v(alphabet_size*2+3,NILNODE);
        std::vector<int> right_child_v(alphabet_size*2+3,NILNODE);
        int curr_node = 0;
        if constexpr(MODE==0){            
            auto root_node = build_tree(0,alphabet_size,alphabet_size,freq,left_child_v,right_child_v) - 1;
            ...
            auto left_top_node = build_tree(0,divide_pos,alphabet_size,freq,left_child_v,right_child_v) - 1;
            auto right_top_node = build_tree(divide_pos,alphabet_size,left_top_node+1,freq,left_child_v,right_child_v) - 1;            
